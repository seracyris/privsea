        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            ...
            <div className="bg-white rounded-lg shadow-lg min-w-[50%] p-5 flex text-black">
                <div className="w-full md:w-1/2 p-10 relative flex flex-col">
                    ...
                    <button className="hover:scale-105 duration-300 py-2 text-slate-100 px-5 mt-5 rounded-xl bg-indigo-800 border-none hover:bg-indigo-600 hover:text-white flex flex-row gap-1 justify-center items-center" onClick={() => window.location.href = 'http://localhost:1337/auth/discord'}>
                        <FaDiscord fontSize={20} />
                        <span className="px-2 py-1">Login with Discord</span>
                    </button>
