...
export function SideBarItem({ onClick, icon, text, active, alert }) {
    ...
    return (
        <li onClick={onClick} className={`text-slate-100 relative flex items-center py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors group ${active ? "bg-gradient-to-tr from-indigo-200 to-indigo-100 text-indigo-800" : "hover:bg-neutral-500 text-gray-200"}`}>
            {icon}
